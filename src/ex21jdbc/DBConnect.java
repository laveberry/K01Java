...
public class DBConnect {
	...
	public static void main(String[] args) {
		try {
				//클래스명 aaa = new 클래스명 (인자); 기존 클래스생성방법
			/*
			 JDBC프로그래밍 절차
			...
			Class.forName("oracle.jdbc.OracleDriver"); //클래스 객체생성과 동일
			...
			if(con!=null) {
				 ...
				 */
				String sql = " SELECT * FROM employees WHERE " //키워드는 대문자로!
						+ " department_id=50 " //앞뒤 공백
						+ " ORDER BY employee_id DESC "; //앞뒤 공백
			...
			//java.sql.SQLSyntaxErrorException : 쿼리오류
		}
	}
}

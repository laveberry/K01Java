...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		//두개의 정수를 나눠서 몫을 반환한다.
		result1 = int1 / int2;//정수와 정수의 연산이므로 정수의결과가 나옴.
		...
		/*
		 -동일자료형끼리의 연산은 동일자료형이 되는것이 기보 원칙임.
		 -큰 자료형과 작은 자료형을 연산하면 큰 자료형으로 자동형번환된다.
		 (데이터의 손실이 있을수 있기때문)

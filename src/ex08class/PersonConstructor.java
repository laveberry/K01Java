...
-반환값이 없다. 즉 특정 연산후 값을 반환할수 없다.
	따라서 void를 쓰지 않는다.
-그외의 메소드가 가진 모든 특성을 가지고있다.(매개변수전달,
	오버로딩 등)
...
public class PersonConstructor {
	...
	/*
	 디폴트 생성자
	 	...
	 	아래와 같이 매개변수, 실행부가 없는 생성자가
	 	자동으로 삽입된다. 단, 생성자를 하나라도
	 	정의하면 디폴트 생성자는 삽입되지 않는다.
	 */
	//public PersonCstructor(){}
	...
	public PersonConstructor(String _name,
			int age, String addr) {
		//매개변수와 멤버변수명이 다르면 this를 쓰지 않아도된다.
		name = _name;

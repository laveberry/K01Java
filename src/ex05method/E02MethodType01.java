...
public class E02MethodType01 {
	...
	static void noPamNoReturn() {
		System.out.println("==메뉴를 선택하세욤==");
		System.out.println("1.열기, 2.계속하기, 3.종료");
		System.out.println("================");
	}
	
	static void noPamNoReturn2() {
		//경우에 따라 함수의 몸체가 없는 경우도 있음.
	}
	
	static void noPamNoReturn2(int a) {
		//동일한 이름의 함수가 정의되었으나 매개변수의 갯수로
		//구분가능하므로 다른함수임.
	}
	
	static void noPamNoReturn3() {
		int returnValue = 81;
		
		//return;
		/*
		 위와 같이함수 중간에 return을 쓰게되면 함수가 즉시 종료되므로

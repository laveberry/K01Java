...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		/*
		 2] charAt(인덱스)
		 	: 문자열의 특정 index에 해당하는 문자 하나를
		 	반환한다. index는 0부터 시작한다.
		 */
		...
		/*
		 6] contains()
		 	: 문자열에 특정 문자열이 포함되어있는지를
		 	판단하여 포함되었으면 true를 반환한다.
		 */
		...
		/*
		 ...
		 프로그램을 작성하시오.
		 */
		//'-'(하이픈)의 위치를 찾아 +1하면 성별에 해당하는 문자를 얻을수있음.
		...
		System.out.println("lastIndexOf:"+
				str1.lastIndexOf("a"));//12(뒤에있는 a의 인덱스)
		...
		/*
		 13] split()
		 	...
		 	변환한다. 해당 구분자가 없는 경우에는 크기가 1인 배열로 반환된다.
		 */
		...
		for(int i=0 ; i<phoneArr.length ; i++) {
			...
			/*
			 14] substring()
			 	...
			 	사용1 : substring(index) -> 이경우 index부터
			 		문자열의 끝까지를 잘라서 반환함.

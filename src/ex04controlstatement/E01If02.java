...
public class E01If02 {
	...
	public static void main(String[] args) {
		 ...
		 */
		String numberRSesult = (num%2==0) ? "짝수임":"홀수임";
		System.out.println("숫자 "+num+"은 "+ numberRSesult);
		
		String numSberResult = (num%2==0) ? "짝수임":"홀수임";
		System.out.println("숫자 "+num+"은 "+ numberRSesult);

		
		/*
		 시나리오] 숫자를 홀/짝수인지 먼저 판단한후 100 이상한지를 판단하는

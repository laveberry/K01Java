...
class Car{
	...
	/*
	 ...
	 초기화를 진행하는 역할은 동일하나, 매개변수를 통해 다양한
	 형태의 객체를 초기화할수있다.
	 */
	void initialize(String model, int year, String name,
		...
		carYear = year;
		/*
		 또다른 객체가 멤버변수로 정의되었으므로, 객체를 생성한후
		 각각의 멤버변수를 초기화해야한다.
		 */
		owner = new Human();
		owner.name = name;
...
public class E03CarMain {
	...
	public static void main(String[] args) {
		...
		//자동차3 객체생성 : 매개변수가 있는 초기화 메소드를 이용하여 초기화
		Car car3 = new Car();
		car3.initialize("스포츠카", 2012, "박서준", 8, 10);
		car3.showCarInfo();
	}
}
